...
public class Address {
	...
	public Address(@NotBlank @Size(min = 5, message = "Street name must be atleast 5 characters") String street,
			...
			@NotBlank @Size(min = 2, message = "State name must be atleast 5 characters") String state,
			@NotBlank @Size(min = 2, message = "Country name must be atleast 5 characters") String country,
			@NotBlank @Size(min = 6, message = "Pincode must be atleast 5 characters") String pincode) {
		super();
		this.street = street;
